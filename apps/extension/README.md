...
`verify` syntax-checks all extension JavaScript and runs the dependency-free Node test suite for the manifest, adapter contract, prompt-safety gate, storage isolation, capture recovery, trusted-origin boundary, and preview result.
